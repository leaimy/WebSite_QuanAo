                    ...
                    <div class="breadcrumb__wrap">
                        <ul class="breadcrumb__list">
                            ...
                            <li class="is-marked">
                                ...
                                <a href="{{route('khachhangtaotaikhoan')}}">Tạo tài khoản</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <form class="l-f-o__form" action="{{route('taotaikhoan')}}" method="post">
                                    ...
                                    <div class="gl-inline">
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input name="first_name" class="input-text input-text--primary-style" type="text" id="reg-fname" placeholder="Nhập tên">
                                        </div>
                                        <div class="u-s-m-b-30">

                                            <label class="gl-label" for="reg-lname">HỌ ĐỆM *</label>

                                            <input name="last_name" class="input-text input-text--primary-style" type="text" id="reg-lname" placeholder="Nhập họ đệm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="gl-inline">
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input name="username" class="input-text input-text--primary-style" type="text" id="reg-username" placeholder="Nhập tên đăng nhập">
                                        </div>
                                        <div class="u-s-m-b-30">

                                            <label class="gl-label" for="reg-email">E-MAIL *</label>

                                            <input name="email" class="input-text input-text--primary-style" type="text" id="reg-email" placeholder="Nhập E-mail">
                                        </div>
                                    </div>
                                    ...
                                    <div class="gl-inline">
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input name="password" class="input-text input-text--primary-style" type="password" id="reg-password" placeholder="Nhập mật khẩu">
                                        </div>
                                        ...
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input name="phone_number" class="input-text input-text--primary-style" type="text" id="billing-phone" data-bill="" placeholder="Nhập số điện thoại">
                                        </div>
                                        <!--====== End - PHONE ======-->
                                    </div>
                                    ...
                                    <div class="gl-inline">
                                        <div class="u-s-m-b-15">
                                            ...
                                            <div class="gl-dob">
                                                <select class="select-box select-box--primary-style" id="tinh">
                                                    <option selected>Tỉnh/Thành Phố</option>

                                                </select>
                                                <select id="quanhuyen" class="select-box select-box--primary-style">
                                                ...
                                                <select id="xaphuong" class="select-box select-box--primary-style">
                                    ...
                                    <div class="gl-inline">
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input name="street" class="input-text input-text--primary-style" type="text" id="billing-street" placeholder="Số nhà/tên đường" data-bill="">
                                        </div>
                                    </div>
                                    <div class="gl-inline">

                                        <button class="btn btn--e-transparent-brand-b-2" type="submit">Tạo tài khoản</button>
                                        <a class="gl-link" style="margin-left: 30px;" href="{{route('frontend.index')}}">Quay về
                                            trang chủ</a>
