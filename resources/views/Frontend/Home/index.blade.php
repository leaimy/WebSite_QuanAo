                                                    ...
                                                    <div class="col-lg-9 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-0.jpg') }}" alt=""></a></div>
                                                    </div>
                                                </div>
                                                <!--====== End - Mega Menu Row ======-->
                                            </div>
                                                    ...
                                                    <div class="col-lg-6 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-1.jpg') }}" alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-6 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-2.jpg') }}" alt=""></a></div>
                                                    </div>
                                                </div>
                                                <!--====== End - Mega Menu Row ======-->
                                                <br>
                                                    ...
                                                    <div class="col-lg-9 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-3.jpg') }}" alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-3 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-4.jpg') }}" alt=""></a></div>
                                                    </div>
                                                </div>
                                                <!--====== End - Mega Menu Row ======-->
                                            </div>
                                                    ...
                                                    <div class="col-lg-4 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-5.jpg') }}" alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-4 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-6.jpg') }}" alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-4 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-7.jpg') }}" alt=""></a></div>
                                                    </div>
                                                </div>
                                                <!--====== End - Mega Menu Row ======-->
                                                <br>
                                                    ...
                                                    <div class="col-lg-6 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-8.jpg') }}" alt=""></a></div>
                                                    </div>
                                                    <div class="col-lg-6 mega-image">
                                                        <div class="mega-banner">
                                                            ...
                                                            <a class="u-d-block" href="shop-side-version-2.html">
                                                                ...
                                                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/banners/banner-mega-9.jpg') }}" alt=""></a></div>
                                                    </div>
                                                </div>
                                                <!--====== End - Mega Menu Row ======-->
                                            </div>
                                                ...
                                                <div class="mini-product">
                                                    <div class="mini-product__image-wrapper">
                                                        ...
                                                        <a class="mini-product__link" href="product-detail.html">
                                                            ...
                                                            <img class="u-img-fluid" src="{{ asset('frontend/images/product/electronic/product3.jpg') }}" alt=""></a></div>
                                                ...
                                                <div class="mini-product">
                                                    <div class="mini-product__image-wrapper">
                                                        ...
                                                        <a class="mini-product__link" href="product-detail.html">
                                                            ...
                                                            <img class="u-img-fluid" src="{{ asset('frontend/images/product/electronic/product18.jpg') }}" alt=""></a></div>
                                                    <div class="mini-product__info-wrapper">
                                                ...
                                                <div class="mini-product">
                                                    <div class="mini-product__image-wrapper">
                                                        ...
                                                        <a class="mini-product__link" href="product-detail.html">
                                                            ...
                                                            <img class="u-img-fluid" src="{{ asset('frontend/images/product/women/product8.jpg') }}" alt=""></a></div>
                                                    <div class="mini-product__info-wrapper">
                                                ...
                                                <div class="mini-product">
                                                    <div class="mini-product__image-wrapper">
                                                        ...
                                                        <a class="mini-product__link" href="product-detail.html">
                                                            ...
                                                            <img class="u-img-fluid" src="{{ asset('frontend/images/product/men/product8.jpg') }}" alt=""></a></div>
                                                    <div class="mini-product__info-wrapper">
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product2.jpg') }}" alt=""></a>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product3.jpg') }}" alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product4.jpg') }}" alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product5.jpg') }}" alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product6.jpg') }}" alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product7.jpg') }}" alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product8.jpg') }}" alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product9.jpg') }}" alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product10.jpg') }}" alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product13.jpg') }}" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product14.jpg') }}" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product15.jpg') }}" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product16.jpg') }}" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product17.jpg') }}" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product18.jpg') }}" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                            ...
                            <div class="product-o product-o--hover-on u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product19.jpg') }}" alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product20.jpg') }}" alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product21.jpg') }}" alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product22.jpg') }}" alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                            ...
                            <a class="promotion" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img promotion__img" src="{{ asset('frontend/images/promo/promo-img-1.jpg') }}" alt=""></div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                            ...
                            <a class="promotion" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img promotion__img" src="{{ asset('frontend/images/promo/promo-img-2.jpg') }}" alt=""></div>
                                <div class="promotion__content">
                                    <div class="promotion__text-wrap">
                                        <div class="promotion__text-1">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                            ...
                            <a class="promotion" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img promotion__img" src="{{ asset('frontend/images/promo/promo-img-3.jpg') }}" alt=""></div>
                                <div class="promotion__content">
                                    <div class="promotion__text-wrap">
                                        <div class="promotion__text-1">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product23.jpg') }}" alt=""></a></div>
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product24.jpg') }}" alt=""></a></div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product25.jpg') }}" alt=""></a></div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product26.jpg') }}" alt=""></a></div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product27.jpg') }}" alt=""></a></div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product28.jpg') }}" alt=""></a></div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product29.jpg') }}" alt=""></a></div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product30.jpg') }}" alt=""></a></div>
                                            <div class="product-l__info-wrap">
                                                <div class="product-l__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i></div>
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" src="{{ asset('frontend/images/product/electronic/product31.jpg') }}" alt=""></a></div>
                                            <div class="product-l__info-wrap">
                                                <div class="product-l__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i></div>
                            ...
                            <div class="bp-mini bp-mini--img u-h-100">
                                <div class="bp-mini__thumbnail">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block" href="blog-detail.html">
                                        ...
                                        <img class="aspect__img" src="{{ asset('frontend/images/blog/post-2.jpg') }}" alt=""></a>
                                    <!--====== End - Image Code ======-->
                                </div>
                            ...
                            <div class="bp-mini bp-mini--img u-h-100">
                                <div class="bp-mini__thumbnail">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block" href="blog-detail.html">
                                        ...
                                        <img class="aspect__img" src="{{ asset('frontend/images/blog/post-12.jpg') }}" alt=""></a>
                                    <!--====== End - Image Code ======-->
                                </div>
                                <div class="bp-mini__content">
                                    <div class="bp-mini__stat">
                            ...
                            <div class="bp-mini bp-mini--img u-h-100">
                                <div class="bp-mini__thumbnail">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block" href="blog-detail.html">
                                        ...
                                        <img class="aspect__img" src="{{ asset('frontend/images/blog/post-5.jpg') }}" alt=""></a>
                                    <!--====== End - Image Code ======-->
                                </div>
                                <div class="bp-mini__content">
                                    <div class="bp-mini__stat">
                                ...
                                <div class="pd-wrap">
                                    <div id="js-product-detail-modal">
                                        <div>
                                            ...
                                            <img class="u-img-fluid" src="{{ asset('frontend/images/product/product-d-1.jpg') }}" alt=""></div>
                                        <div>

                                            <img class="u-img-fluid" src="{{ asset('frontend/images/product/product-d-2.jpg') }}" alt=""></div>
                                        <div>

                                            <img class="u-img-fluid" src="{{ asset('frontend/images/product/product-d-3.jpg') }}" alt=""></div>
                                        <div>

                                            <img class="u-img-fluid" src="{{ asset('frontend/images/product/product-d-4.jpg') }}" alt=""></div>
                                        <div>

                                            <img class="u-img-fluid" src="{{ asset('frontend/images/product/product-d-5.jpg') }}" alt=""></div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="success u-s-m-b-30">
                                ...
                                <div class="success__img-wrap">
                                    ...
                                    <img class="u-img-fluid" src="{{ asset('frontend/images/product/electronic/product1.jpg') }}" alt=""></div>
                    ...
                    <div class="row u-s-m-x-0">
                        <div class="col-lg-6 new-l__col-1 u-s-p-x-0">
                            ...
                            <a class="new-l__img-wrap u-d-block" href="shop-side-version-2.html">
                                ...
                                <img class="u-img-fluid u-d-block" src="{{ asset('frontend/images/newsletter/newsletter.jpg') }}" alt=""></a></div>
