                    ...
                    <div class="breadcrumb__wrap">
                        <ul class="breadcrumb__list">
                            ...
                            <li class="is-marked">
                                ...
                                <a href="{{route('khachhangdangnhap')}}">Đăng nhập</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="l-f-o">
                            <div class="l-f-o__pad-box">
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <a class="l-f-o__create-link btn--e-transparent-brand-b-2" href="{{route('khachhangtaotaikhoan')}}">TẠO MỘT TÀI KHOẢN</a>
                                </div>
                                ...
                                <form action="{{route('dangnhap')}}" method="post" class="l-f-o__form">
                                    ...
                                    <div class="u-s-m-b-30">
                                        ...
                                        <input name="username" class="input-text input-text--primary-style" type="text" id="login-email" placeholder="Vui lòng nhập tên đăng nhập">
                                    </div>
                                    <div class="u-s-m-b-30">

                                        <label class="gl-label" for="login-password">MẬT KHẨU *</label>

                                        <input name="password" class="input-text input-text--primary-style" type="password" id="login-password" placeholder="Vui lòng nhập mật khẩu">
                                    </div>
                                    <div class="gl-inline">
                                        <div class="u-s-m-b-30">
