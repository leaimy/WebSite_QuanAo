                            ...
                            <div class="card-body">
                                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <a href="{{route('AdminCategory.create')}}" class="btn btn-primary">Thêm
                                                nhóm mới</a>
                                            ...
                                            <table id="example1"
                                                ...
                                                @for($i=0;$i<count($category);$i++)
                                                    <tr class="@if($i%2==0) even @else odd @endif">
                                                        <td class="dtr-control sorting_1" tabindex="0">{{$category[$i]['name']}}</td>
                                                        <td>0</td>
                                                        <td>
                                                            ...
                                                            <a href="{{route('AdminCategory.edit', ['id'=>$category[$i]['id']])}}" class="d-inline-block mr-3"><i
                                                                    class="fas fa-edit"></i></a>
                                                            <a href="{{route('AdminCategory.delete', ['id'=>$category[$i]['id']])}}"><i class="fas fa-trash-alt"></i></a>
                                                        </td>
